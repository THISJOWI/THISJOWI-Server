    ...
    public ResponseEntity<?> testLdapConnection(
        ...
        try {
            ...
            if (response.isSuccess()) {
                ...
                log.warn("LDAP connection test failed: {}",
                        response.getConnectionError() != null ? response.getConnectionError()
                                : response.getCredentialsError());
